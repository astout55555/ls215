...
//   return randomElements; // returns an array with string elements
// }
...
// // here's the bug: must concat to combine arrays, cannot just add with `+`
// // otherwise you end up with a string, and String.join() is not a function!

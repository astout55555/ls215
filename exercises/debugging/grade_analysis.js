...
//   nums.sort(); // BUG: does not sort numbers by numerical size!
...
function median(nums) {
  nums.sort((num1, num2) => (num1 - num2)); // added the callback function
...
console.log(median(quarter1ExamScores) === 89.5); // fails
console.log(median(quarter2ExamScores) === 89.5);
console.log(median(quarter3ExamScores) === 87);
console.log(median(quarter4ExamScores) === 89.5); // fails
